...
public class MultiplyHandler implements OperationHandler {
    ...
    public boolean supports(Operation operation) {
        boolean supported = operation == Operation.MULTIPLY;
        log.debug("MultiplyHandler supports check for operation {}: {}", operation, supported);
        return supported;
    }
    ...
    public Number apply(Number a, Number b) {
        ...
        log.info("Multiplying {} * {} = {}", a, b, result);
        return result;
    }
}
